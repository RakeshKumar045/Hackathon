...
type_of_cab = {'A': 00, 'B': 11, 'C': 22, 'D': 33, 'E': 44}
...
params = {"objective": "multi:softmax", "booster": "gbtree", "nthread": 4, "silent": 1,
          "eta": 0.05, "max_depth": 6, "subsample": 0.9, "colsample_bytree": 0.7}
...
submission = pd.DataFrame({'Trip_ID': test['Trip_ID'], 'Surge_Pricing_Type': test_preds + 1})
